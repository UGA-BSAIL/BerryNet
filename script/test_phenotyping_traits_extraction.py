...
def blueberry_cluster(img_org, boxes, masks, contour_area_filter = 3000):
    ...
    for contour in contours:
        ...
        if area > contour_filter:
            ...
            img_org = cv2.addWeighted(img_org, 1, mask_overlay, 0.15, 0)
    ...
    cv2.imwrite('density_map_cluster_top_FLR-13-218.png', img_org)
    print("density_map_cluster_top_FLR-13-218.png saved.")
...
image_path ="/blue/lift-phenomics/zhengkun.li/blueberry_project/data/ASABE_dataset/blueberry_crop_single_total/test/images/top_FLR-13-218_jpg.rf.eae1e4fb6ec5d9cbe4d2e524c373eb26.jpg"
...
output_path = 'mask_overlay_top_FLR-13-218_all_mask1.jpg'
