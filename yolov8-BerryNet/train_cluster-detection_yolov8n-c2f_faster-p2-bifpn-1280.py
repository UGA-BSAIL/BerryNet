...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='/blue/lift-phenomics/zhengkun.li/yolov8/ultralytics/models/v8/yolov8-c2f_faster-p2-bifpn.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', type=str, default=ROOT / '/blue/lift-phenomics/zhengkun.li/blueberry_project/training_result/cluster_detection/yolov8-c2f_faster-p2-bifpn-1280', help='save to project/name')
...
class YOLOV8(YOLO):
    ...
    '''
    def __init__(self, yaml='/blue/lift-phenomics/zhengkun.li/yolov8/ultralytics/models/v8/yolov8-c2f_faster-p2-bifpn.yaml', weight='', task=None) -> None:
