...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='/blue/lift-phenomics/zhengkun.li/yolov8/ultralytics/models/v8/yolov8x-c2f_faster-p2-bifpn-seg.yaml', help='model.yaml path')
    ...
    parser.add_argument('--batch', type=int, default=2, help='number of images per batch (-1 for AutoBatch)')
    ...
    parser.add_argument('--project', type=str, default="/blue/lift-phenomics/zhengkun.li/blueberry_project/training_result/segmentation/yolov8x-c2f_faster_p2_bifpn-seg-1280", help='save to project/name')
...
class YOLOV8(YOLO):
    ...
    '''
    def __init__(self, yaml='/blue/lift-phenomics/zhengkun.li/yolov8/ultralytics/models/v8/yolov8x-c2f_faster-p2-bifpn-seg.yaml', weight='', task=None) -> None:
