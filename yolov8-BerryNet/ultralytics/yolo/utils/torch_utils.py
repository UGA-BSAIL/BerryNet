...
# def model_info(model, detailed=False, verbose=True, imgsz=1280):
    ...
    LOGGER.info('---------------------------------------------')
    LOGGER.info(f'{model_name} summary{fused}: imgsz:{imgsz}, {n_l} layers, {n_p} parameters, {n_g} gradients{fs}')
...
# def get_flops_with_torch_profiler(model, imgsz=1280):
