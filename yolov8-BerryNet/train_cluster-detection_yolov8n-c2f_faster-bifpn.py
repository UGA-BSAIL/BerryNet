...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='/blue/lift-phenomics/zhengkun.li/yolov8/ultralytics/models/v8/yolov8-c2f_faster-bifpn.yaml', help='model.yaml path')
    ...
    parser.add_argument('--data', type=str, default='/blue/lift-phenomics/zhengkun.li/blueberry_project/data/cluster_detection_train/data.yaml', help='data yaml path')
    ...
    parser.add_argument('--imgsz', type=int, default=1280, help='size of input images as integer')
    parser.add_argument('--cache', type=str, nargs='?', const='ram', help='image --cache ram/disk')
    parser.add_argument('--device', type=str, default='', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--workers', type=int, default=8, help='max dataloader workers (per RANK in DDP mode)')
    parser.add_argument('--project', type=str, default=ROOT / '/blue/lift-phenomics/zhengkun.li/blueberry_project/training_result/cluster_detection/yolov8-c2f_faster-bifpn-1280', help='save to project/name')
...
class YOLOV8(YOLO):
    ...
    '''
    def __init__(self, yaml='/blue/lift-phenomics/zhengkun.li/yolov8/ultralytics/models/v8/yolov8-c2f_faster-bifpn.yaml', weight='', task=None) -> None:
